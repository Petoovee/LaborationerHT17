...
public class Exercise7o {
    ...
    public void movePictures()
    {
    	...
    	while(true)
    	{
    		man1.checkDirection(maxX, maxY); man1.move(); // Checks picture for clearance and reverses their direction
    		man2.checkDirection(maxX, maxY); man2.move(); // if necessary, then moves them
    		PaintWindow.pause(20);
    		showPicture(man1); showPicture(man2); // Renders the new pictures
