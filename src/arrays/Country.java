...
/**
 * Klassen Country lagrar information om ett land. Det är landets namn och dess
 * befolkning som lagras.
 * 
...
public class Country implements Comparable {
	...
	/**
	 * Beskriver ett lands befolkning på formen "Landsnamn 32987800". Landsnamnet är
	 * vänsterjusterat i ett 30 tecken brett fält och befolkningen är högerjusterad
	 * i ett 12 tecken brett fält.
	 */
