...
/**
 * I ett fönster av typen PaintWindow kan man visa bilder och rita linjer,
 * ellipser och rektanglar. När fönstret skapas kan man ange en bild som ska
 * vara bakgrundsbild.
 * 
...
public class PaintWindow extends JFrame {
	...
	/**
	 * Skapar ett PaintWindow-objekt med angiven bakgrundsbild. Storleken på
	 * fönstret blir bildens storlek, dock max 800x800 pixlar stort
	 * 
	 * @param background
	 *            bakgrundsbild att visa i PaintWindow. Om null så skapas ett
	 *            600x400 pixlar stort fönster med vit bakgrund.
	 */
	public PaintWindow(ImageIcon background) {
		...
		if (background != null) {
			panel.setPreferredSize(
					new Dimension(Math.min(background.getIconWidth(), 800), Math.min(background.getIconHeight(), 800)));
		} else {
	 ...
	 * 
	 * @param icon
	 *            Ett ImageIcon-objekt att visa i fönstret
	 */
	...
	/**
	 * Visar en Icon-implementering på angiven plats. Om icon-implementeringen redan
	 * visas i fönstret så flyttas den till angiven position.
	 * 
	 * @param icon
	 *            Icon-implementering att visa
	 * @param x
	 *            Anger x-position för övre vänstra hörnet i Icon-implementeringen
	 * @param y
	 *            Anger y-position för övre vänstra hörnet i Icon-implementeringen
	 */
	 ...
	 * 
	 * @param icon
	 *            Icon-implementeringen som ska tas bort
	 */
	 ...
	 * 
	 * @param x1
	 *            x-koordinat i första punkten
	 * @param y1
	 *            y-koordinat i första punkten
	 * @param x2
	 *            x-koordinat i andra punkten
	 * @param y2
	 *            y-koordinat i andra punkten
	 * @param color
	 *            ritfärg
	 * @param lineWidth
	 *            linjens tjocklek
	 ...
	 * 
	 * @param x
	 *            x-koordinat i rektangeln övre vänstra hörn
	 * @param y
	 *            y-koordinat i rektangeln övre vänstra hörn
	 * @param width
	 *            rektangelns bredd
	 * @param height
	 *            rektangelns höjd
	...
	/**
	 * ritar en fylld ellips innesluten i en rektangel med övre vänstra hörnet i
	 * (x,y).
	 * 
	 * @param x
	 *            x-koordinat i rektangeln övre vänstra hörn
