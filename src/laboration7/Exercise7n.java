...
public class Exercise7n {
    ...
    public void movePictures() {
    	...
    	while(true) {
    		...
    		showPicture(man1); showPicture(man2); //Renders the new frame
    		
    		if(man1.getX()>maxX || man1.getX()<0) {man1.setDx(-man1.getDx());} //Reverses the horizontal mans velocity
    		if(man2.getY()>maxY || man2.getY()<0) {man2.setDy(-man2.getDy());} //Reverses the vertical mans velocity
