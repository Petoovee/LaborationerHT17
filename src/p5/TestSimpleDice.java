	...
	public static void main(String[] args) {
		...
		while (sides != -10) {
			try {
				...
				// Skapa en array f�r att r�kna antalet 1:or, 2:or osv som t�rningen visar
				// vid kasten nedan
				result = new int[sides];
				TextWindow.println("----- 100000 kast med " + dice.getSides() + "-sidig tärning ----- ");
				// Loop som upprepas 100000 ggr. Vid varje upprepning kastas t�rningen och
				// r�knaren f�r antalet
				// prickar vid kastet r�knas upp. result[ 0 ] �r r�knare f�r antalet
				// 1:or, result[ 1 ] �r r�knare
			...
			sides = Integer
					.parseInt(JOptionPane.showInputDialog("Hur många sidor ska tärningen ha? (-10 för avbrott)"));
		}
	}
}
