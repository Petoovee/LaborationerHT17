 ...
 * förra kastet visade största antalet prickar. Då kommer kastet att visa en
 * prick.
 * 
...
public class PredictableDice implements Dice {
	 ...
	 * 
	 * @throws NegativeSidesException Om värdet på <code>sides</code> är mindre
	 * eller lika med 0
	 **/
	 ...
	 * 1 - <code>sides</code> och i ordningen: 1, 2, 3, ..., sides-1, sides, 1, 2,
	 * osv
	 * 
