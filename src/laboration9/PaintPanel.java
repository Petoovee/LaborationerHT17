...
public class PaintPanel extends JPanel {
	...
	/**
	 * En panel med bakgrundsbilden <code>background</code> skapas. PreferredSize
	 * sätts till bildens storlek. Maximal storlek är 800x800 pixlar.
	 *
	 * @param background
	...
	/**
	 * Ändrar bakgrunden till bilden <code>icon</code>. Bakgrundens storlek ändras
	 * ej.
	 *
	 * @param icon
